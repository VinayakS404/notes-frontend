...
function HomeSearchDiv() {
  return (
    <div className=" w-full h-30  fixed left-0 flex justify-start  bg-sky-50 shadow-sm">
      <div className=" h-full w-[calc(100%-150px)] flex items-center justify-center gap-2">
        ...
        <div className="h-12 rounded-xl bg-gray-100 border-2 border-gray-300 gap-3 px-3 flex items-center justify-center">
